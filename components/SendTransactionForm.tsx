...
export default function SendTransactionForm() {
    ...
    return (
      ...
      `}</style>
            ...
            {isError && <div className="text-red-500">Could not process the transaction. Please retry.</div>}
            {isConfirmed && <div className="text-green-500">Transaction confirmed. You can return to the main app.</div>}
            {txHash && <div className="break-all">Transaction hash: {txHash}</div>}
